...
$(function () {
    ...
    function menuItem() {
    	...
    	$('.bg-blue-active').css(oldCssObj).removeClass('bg-blue-active');
        ...
        $('.J_menuTab').each(function () {
            if ($(this).data('index') == dataIndex) {
            	// 选项卡菜单已存在
            	/*
            	 * var target = $('.J_iframe[data-index="' + dataIndex + '"]');
        ...
        // 选项卡菜单不存在
        if (flag) {
            var str = '<a href="javascript:;" class="active J_menuTab" title="双击可刷新当前页面"  data-index="' + dataIndex + '" >' + menuName + ' <i class="fa fa-times-circle"></i></a>';
            $('.J_menuTab').removeClass('active');

            // 添加选项卡对应的iframe
            var str1 = '<iframe class="J_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0"  data-index="' + dataIndex + '"  seamless></iframe>';
            ...
            // 总宽度
            var countWidth = $(".content-tabs").width() - 160;
    ...
    // 双击刷新
    $('.J_menuItem').on('dblclick', function() {
    ...
    function closeTab() {
        ...
        var closeTabId = $(this).parents('.J_menuTab').data('index');
        ...
        if ($(this).parents('.J_menuTab').hasClass('active')) {
            ...
            if ($(this).parents('.J_menuTab').next('.J_menuTab').size()) {
                ...
                var activeId = $(this).parents('.J_menuTab').next('.J_menuTab:eq(0)').data('index');
            ...
            if ($(this).parents('.J_menuTab').prev('.J_menuTab').size()) {
                var activeId = $(this).parents('.J_menuTab').prev('.J_menuTab:last').data('index');
    ...
    function closeOther(){
    	$(".page-tabs-content").children("[data-index]").not(":first").not(".active").each(function(){
    		$('.J_iframe[data-index="'+$(this).data("index")+'"]').remove(),$(this).remove()
    	})
    ...
    $(".J_tabCloseAll").on("click",function(){
    	...
    	$(".page-tabs-content").children("[data-index]:first").each(function(){
    		$('.J_iframe[data-index="'+$(this).data("index")+'"]').show(),$(this).addClass("active")
    	}),
    	$(".page-tabs-content").css("margin-left","0");
