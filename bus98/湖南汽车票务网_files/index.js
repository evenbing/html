...
baseUrl:  "/site/js",
	paths: {
		...
		"slider": "lib/TouchSlider",/*轮播图*/
		"calendar":"lib/calendar",/*日期选择*/
		"findCitys":"findCitys.js?v=1.2",
		"alertt":"lib/zepto.alert",/*提示框*/
		"template":"app/utils/template",
		"api":"app/utils/api",
		"city":"app/utils/city.js?v=1.1",
	    'common': 'lib/common-utils',
	    'baiduMap':'lib/baidu_map',
		"appFunc":"app/utils/appFunc",//定义function
		"dateHandler":"app/utils/dateHandler"
	},
    shim:{
    	zepto: {
    		exports: '$'
